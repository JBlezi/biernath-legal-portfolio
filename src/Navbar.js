  ...
  return (
    <nav className="p-4 text-black">
      <div className="flex items-center justify-between lg:mx-10 lg:mt-10">
        <Link to="/home"><img src={logo} alt="Biernath Legal Logo" className="h-14 rounded-full" /></Link>
        <div className='wrap flex flex-row'>
          <div className='fill-wrap'>
            ...
            <a href='mailto:ra@biernath.com' className='btn btn-desert btn-b-t md:p-4 p-3 text-xl rounded-full'>{t('navbar.contact')}</a>
          </div>
        </div>
      </div>
    </nav>
